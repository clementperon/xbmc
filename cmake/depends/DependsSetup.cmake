...
function(kodi_depends_read_makefile_include makefile_include_path)
  ...
  if(KODI_DEPENDS_HAVE_ZLIB STREQUAL "")
    # Legacy Makefile logic builds zlib unless HAS_ZLIB is exactly 1.
    set(KODI_DEPENDS_HAVE_ZLIB "0")
  endif()
  if(KODI_DEPENDS_NEED_LIBICONV STREQUAL "")
    set(KODI_DEPENDS_NEED_LIBICONV "0")
  endif()
