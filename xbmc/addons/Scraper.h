...
public:
  ...
  std::vector<MUSIC_GRABBER::CMusicArtistInfo> FindArtist(
    XFILE::IHttpClient& fcurl, const std::string& sArtist);
  ...
  bool GetVideoDetails(XFILE::IHttpClient& fcurl,
                       ...
                       CVideoInfoTag& video);
  bool GetAlbumDetails(XFILE::IHttpClient& fcurl, const CScraperUrl& scurl,
    CAlbum &album);
  bool GetArtistDetails(XFILE::IHttpClient& fcurl, const CScraperUrl& scurl,
