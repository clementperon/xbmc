...
// Without this gate the whole TU is empty: the <taglib/matroska*.h> includes below do not exist
// before TagLib 2.2. See TagLibVersion.h for why the floor is 2.3.1.
