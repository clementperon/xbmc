 ...
 * along the way. ARTIST it splits on this alone, because that list holds "/" and in an artist a
 * slash is as likely inside a name as between two - AC/DC. So join with exactly this.
 */
