...
const std::vector<WrapTestParam> wrapCases{
    ...
    {"CjkWrapsBetweenIdeographs", kZhongWen + kZhongWen + kZhongWen, 4.0f,
    ...
    {"CjkAndLatinInterleaved", L"中" L"a" L"文" L"b", 3.0f, {L"中a", L"文b"}},
    {"CjkWithAsciiSpaces", kZhongWen + L" abc", 4.0f, {kZhongWen, L"abc"}},
    {"CjkIdeographicSpaceIsASeparator", kZhongWen + kIdeographicSpace + kZhongWen, 4.0f,
     {kZhongWen, kZhongWen}},
    ...
    {"NoTrailingIdeographicSpace", kZhongWen + kIdeographicSpace + L"abcd", 6.0f,
     {kZhongWen, L"abcd"}},
};
...
TEST(TestGUITextLayoutWrap, StyleBitsDoNotAffectBreaks)
{
  ...
  for (wchar_t ch : kZhongWen + L"Kodi")
    styled.push_back((static_cast<character_t>(FONT_STYLE_BOLD) << 24) | (1u << 16) | static_cast<character_t>(ch));
